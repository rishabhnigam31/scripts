...
alias listdir='du -sh *'
alias runwifi='sudo ./wifi wlan0 eth0'
alias emacs='emacs -nw'
alias auth='python auth.py rishabhn Hackathon'
alias unmountAndroid='fusermount -u ~/Android'
alias mountAndroid='go-mtpfs ~/Android'
